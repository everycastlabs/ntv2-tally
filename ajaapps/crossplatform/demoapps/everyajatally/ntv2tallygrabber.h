...
/**
    @file        ntv2tallygrabber.h
    @brief        Declares the NTV2TallyGrabber class.
...
class NTV2TallyGrabber
{
	...
	public:
		...
		**/
		NTV2TallyGrabber (const CaptureConfig & inConfig);

		virtual						~NTV2TallyGrabber ();
